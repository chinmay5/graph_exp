...
root_folder = os.path.join(PROJECT_ROOT_DIR, 'data')
...
if __name__ == '__main__':
    subject_list = ['50003', '50004', '50005', '50006']
    # scores = ['SEX', 'AGE_AT_SCAN', 'FIQ', 'DX_GROUP']
    # graph = create_affinity_graph_from_scores(scores=scores, subject_list=subject_list)
    # print(graph)
    graph = get_networks(subject_list=subject_list, kind='correlation', atlas_name='ho')
    print(graph)
